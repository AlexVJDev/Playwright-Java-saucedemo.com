...
public class ProblemUserTest extends BaseTest {
    ...
    @Test
    @DisplayName("(Should fail and reveal a bug.) ProblemUser. inventory page should have correct image-name")
    ...
    @Test
    @DisplayName("(Should fail and reveal a bug.) ProblemUser. Inventory-page should get correct total items number in the cart")
    ...
    @Test
    @DisplayName("(Should fail and reveal a bug.) ProblemUser. The product is not removed from the shopping list in inventoryPage")
    ...
    @Test
    @DisplayName("(Should fail and reveal a bug.) ProblemUser. Price on item detail page not match expected catalog price")
    ...
    @Test
    @DisplayName("(Should fail and reveal a bug.) ProblemUser. Price on item detail page not match expected catalog name")
    ...
    @Test
    @DisplayName("(Should fail and reveal a bug.) ProblemUser: Add to cart on inventory-item page must increase cart badge")
